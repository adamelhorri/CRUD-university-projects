...
class EntitePersonne extends AbstractEntite
{
    ...
    {
        return "object:EntitePersonne (" . $this->idPersonne . ", " . $this->nomPersonne . ", " . $this->paysPersonne . ", " . $this->dateNaissancePersonne . ", " . $this->dateDecesPersonne . ", " . $this->genrePersonne . ", " . $this->fonctionPersonne . ", " . $this->imagePersonne . ")";
    }
}
?>