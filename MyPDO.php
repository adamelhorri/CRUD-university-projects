...
class MyPDO
{
    ...
    public function getAll(): array
    {
        ...
        return $this->getPdosSelectAll()->fetchAll(PDO::FETCH_CLASS, 'php-crud\Entites\Entite' . ucfirst($this->getNomTable()));
    }
    ...
    public function get(string $key, $val) : AbstractEntite
    {
        ...
        return $this->getPdosSelect()->fetchObject('php-crud\Entites\Entite' . ucfirst($this->getNomTable()));
    }
